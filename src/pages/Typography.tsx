...
export default function Typography() {
  return (
    <DefaultLayout pageTitle="Typography">
        ...
        <div className="card-body">
          <div className="row g-4">
            <div className="col-12 prose">
              <h1>1/1 Text</h1>
              <p>
                I'm not a witch. Now, look here, my good man. Oh! Come and see the violence inherent in the system! Help,
                help, I'm being repressed! Well, I didn't vote for you. You can't expect to wield supreme power just
                'cause some watery tart threw a sword at you! Bring her forward! He hasn't got shit all over him. He
            ...
            <div className="col-md-6 prose">
              <h2>1/2 Text</h2>
              <p>
                What do you mean? We shall say 'Ni' again to you, if you do not appease us. I have to push the pram a lot.
                No, no, no! Yes, yes. A bit. But she's got a wart. What a strange person.
              </p>
            </div>
            ...
            <div className="col-md-8 prose">
              <h3>2/3 Text</h3>
              <p>
                Well, I got better. Knights of Ni, we are but simple travelers who seek the enchanter who lives beyond
                these woods. Found them? In Mercia?! The coconut's tropical! A newt? …Are you suggesting that coconuts
                migrate?
              </p>
            </div>
            ...
            <div className="col-md-8 prose">
              <p>
                I don't want to talk to you no more, you empty-headed animal food trough water! I fart in your general
                direction! Your mother was a hamster and your father smelt of elderberries! Now leave before I am
                forced to taunt you a second time! We want a shrubbery!!
              </p>
              <p>
            ...
            <div className="col-12 prose">
              ...
              <blockquote className="blockquote">
                <p>
                  I don't want to talk to you no more, you empty-headed animal food trough water! I fart in your general
                  direction! Your mother was a hamster and your father smelt of elderberries! Now leave before I am
                  forced to taunt you a second time! The nose?
                </p>
            ...
            <div className="col-md-4 prose">
              ...
              <div>
                The following snippet of text show useful keyboard shortcut: <kbd>⌘</kbd> + <kbd>C</kbd> or <kbd>ctrl</kbd>{' '}
                + <kbd>C</kbd>.
              </div>
            </div>
