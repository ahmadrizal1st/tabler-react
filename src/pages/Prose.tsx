...
export default function Prose({ photos = [] }: ProseProps) {
  const photo = photos[5] || { path: '', title: 'Image' }

  return (
    <DefaultLayout sidebar={false} pageTitle="Prose">
        ...
        <div className="col-lg-10 col-xl-9">
          <div className="card card-lg">
            <div className="card-body prose">
              ...
              <p>
                <strong>Strange women lying in ponds distributing swords is no basis for a system of government.</strong>{' '}
                <em>Supreme executive power derives from a mandate from the masses, not from some farcical aquatic ceremony.</em> The swallow may fly south with the sun, and the house martin or the plover may seek warmer climes in winter, yet these are not strangers to our land.
              </p>
